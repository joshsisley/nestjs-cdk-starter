...
Naming things is hard and can lead to a lot of confusion if not consistent. This sheet attempts to make it easier and set a standard.

## Naming convention

This project uses the **camelCase** naming convention.
